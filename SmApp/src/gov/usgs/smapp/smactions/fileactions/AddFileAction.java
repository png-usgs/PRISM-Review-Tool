/*******************************************************************************
 * Name: Java class AddFileAction.java
...
@ActionID(
        category = "File",
        id = "gov.usgs.smapp.smactions.fileactions.AddFileAction"
)
@ActionRegistration(
        iconBase = "resources/icons/add_file_16.png",
...
@Messages("CTL_AddFileAction=Add File ...")
